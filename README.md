...
<dt><a href="#getCustomerInfoFromReceipt">getCustomerInfoFromReceipt(receiptUrl)</a></dt>
<dd><p>Extracts AID from customer recipt based on Url, only to be used for Card Transactions</p>
</dd>
</dl>
...
| Param | Type | Description |
| --- | --- | --- |
| categoryId | <code>String</code> | category ID to delete |
| callback | <code>function</code> |  |
...
| Param | Type | Description |
| --- | --- | --- |
| itemId | <code>String</code> | item ID to fetch |
| callback | <code>function</code> |  |
...
| Param | Type | Description |
| --- | --- | --- |
| itemId | <code>String</code> | Item ID to delete |
| callback | <code>function</code> |  |
...
| --- | --- | --- |
| itemId | <code>String</code> | Item ID for referencing child Variation |
| variationId | <code>String</code> | Variation ID to Delete |
| callback | <code>function</code> |  |
...
| Param | Type | Description |
| --- | --- | --- |
| paymentId | <code>String</code> | payment ID to fetch |
| callback | <code>function</code> |  |

<a name="getCustomerInfoFromReceipt"></a>

## getCustomerInfoFromReceipt(receiptUrl)

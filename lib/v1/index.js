 ...
 * @param  {Function} callback
 */
squareConnect.prototoype.listFees = function listFees(queryParams, callback) {
  callback = Array.prototype.pop.call(arguments);
  switch (arguments.length) {
    case 1:
      queryParams = null;
...
/**
 * Applies a Fee to an Item based on provided Fee and Item Id's
 ...
 */
squareConnect.listModifierLists = function listModifierLists(callback) {
 ...
 */
squareConnect.getModifierList = function getModifierList(modifierListId, callback) {
 ...
 * @param  {Function} callback
 */
squareConnect.createModifierList = function createModifierList(data, callback) {
 ...
 * @param  {Function} callback
 */
squareConnect.updateModifierList = function updateModifierList(modifierListId, data, callback) {
 ...
 * @param  {Function} callback
 */
squareConnect.deleteModifierList = function deleteModifierList(modifierListId, callback) {
 ...
 * @param  {Function} callback
 */
squareConnect.applyModifierList = function applyModifierList(modifierListId, itemId, callback) {
 ...
 * @param  {Function} callback
 */
squareConnect.removeModifierList = function removeModifierList(modifierListId, itemId, callback) {

 ...
 * @param  {Function} callback
 */
exports.listDiscounts = function listDiscounts(queryParams, callback) {
  callback = Array.prototype.pop.call(arguments);
  switch (arguments.length) {
    case 1:
      queryParams = null;
 ...
 * @param  {Function} callback
 */
exports.createDiscount = function createDiscount(data, callback) {
 ...
 * @param  {Function} callback
 */
exports.updateDiscount = function updateDiscount(discountId, data, callback) {
 ...
 */
exports.deleteDiscount = function deleteDiscount(discountId, callback) {
 ...
 * @param  {Function} callback
 */
exports.createModifierOption = function createModifierOption(modifierListId, data, callback) {
 ...
 * @param  {Function} callback
 */
exports.updateModifierOption = function updateModifierOption(modifierListId, modifierOptionId, data, callback) {
 ...
 */
exports.deleteModifierOption = function deleteModifierOption(modifierListId, modifierOptionId, callback) {
